...
# ============================================================================
    ...
    # CompactWatcher (JSONL polling) tests removed — compact detection
    # now uses PTY stream via detect_compact_event() in the main loop.
    # See test_modal_detector.py for the new detector tests.
